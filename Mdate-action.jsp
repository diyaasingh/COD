<%-- 
    Document   : Mdate-action
    Created on : 8 Mar, 2024, 2:38:08 AM
    Author     : DELL
--%>
...
<div class="container">
        <center>
            ...
            <h2>Mechanics near me!</h2>
            <div>
                <form id="myForm" action="Mdate-action.jsp" method="post">
...
<select id="timeSlot" name="timeSlot" onchange="submitForm()">
  ...
  <option value="4:00 PM - 5:00 PM">4:00 PM - 5:00 PM</option>
    ...
    <form id="myForm1" action="Mdate-action.jsp" method="post">
...
<!--            <button onclick="window.location.href='electrician.jsp'">ALL</button>-->
    ...
    <%
        ...
        if ("button1".equals(buttonValue)) {
            ...
            sqlQuery = "SELECT FIRST_NAME,SP_ID FROM SP WHERE TYPE = 'Mechanic' AND CD_2 = true";
        } else if ("12:00 PM - 1:00 PM".equals(selectedTimeSlot)) {
            sqlQuery = "SELECT FIRST_NAME,SP_ID FROM SP WHERE TYPE = 'Mechanic' AND CD_3 = true";
        } else if ("1:00 PM - 2:00 PM".equals(selectedTimeSlot)) {
            sqlQuery = "SELECT FIRST_NAME,SP_ID FROM SP WHERE TYPE = 'Mechanic' AND CD_4 = true";
        } else if ("2:00 PM - 3:00 PM".equals(selectedTimeSlot)) {
            sqlQuery = "SELECT FIRST_NAME,SP_ID FROM SP WHERE TYPE = 'Mechanic' AND CD_5 = true";
        } else if ("3:00 PM - 4:00 PM".equals(selectedTimeSlot)) {
            sqlQuery = "SELECT FIRST_NAME,SP_ID FROM SP WHERE TYPE = 'Mechanic' AND CD_6 = true";
        } else if ("4:00 PM - 5:00 PM".equals(selectedTimeSlot)) {
            sqlQuery = "SELECT FIRST_NAME,SP_ID FROM SP WHERE TYPE = 'Mechanic' AND CD_7 = true";
        } else {
            // Handle invalid button value
            sqlQuery="SELECT FIRST_NAME,SP_ID FROM SP WHERE TYPE = 'Mechanic' AND CD_1 = TRUE";
        }
        } else if ("button2".equals(buttonValue)) { 
            if ("11:00 AM - 12:00 PM".equals(selectedTimeSlot)) {
            sqlQuery = "SELECT FIRST_NAME,SP_ID FROM SP WHERE TYPE = 'Mechanic' AND CD1_2 = true";}
         else if ("12:00 PM - 1:00 PM".equals(selectedTimeSlot)) {
            sqlQuery = "SELECT FIRST_NAME,SP_ID FROM SP WHERE TYPE = 'Mechanic' AND CD1_3 = true";
        } else if ("1:00 PM - 2:00 PM".equals(selectedTimeSlot)) {
            sqlQuery = "SELECT FIRST_NAME ,SP_ID FROM SP WHERE TYPE = 'Mechanic' AND CD1_4 = true";
        } else if ("2:00 PM - 3:00 PM".equals(selectedTimeSlot)) {
            sqlQuery = "SELECT FIRST_NAME,SP_ID FROM SP WHERE TYPE = 'Mechanic' AND CD1_5 = true";
        } else if ("3:00 PM - 4:00 PM".equals(selectedTimeSlot)) {
            sqlQuery = "SELECT FIRST_NAME,SP_ID FROM SP WHERE TYPE = 'Mechanic' AND CD1_6 = true";
        } else if ("4:00 PM - 5:00 PM".equals(selectedTimeSlot)) {
            sqlQuery = "SELECT FIRST_NAME,SP_ID FROM SP WHERE TYPE = 'Mechanic' AND CD1_7 = true";
        } else {
        sqlQuery = "SELECT FIRST_NAME,SP_ID FROM SP WHERE TYPE = 'Mechanic' AND CD1_1 = true";
        }} 
        else {
            // Handle invalid button value
            out.println("Invalid button value");

<%-- 
    ...
    Created on : 6 Mar, 2024, 10:53:39 PM
    Author     : DELL
--%>
...
<%
   ...
   String uid = (String) session.getAttribute("USER_ID");
    ...
    try {
        ...
        PreparedStatement pss = con.prepareStatement("UPDATE USERSIGNUP SET FIRST_NAME=?, PASSWORD=? , LAST_NAME=?, ADDRESS = ?, EMAIL=?,PHONENO=? WHERE USER_ID=?");
        pss.setString(1, firstname);
        pss.setString(2, password);
        pss.setString(3, lname);
        pss.setString(4, address);

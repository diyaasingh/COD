...
<body>
    <div class="container">
        <center>
         ...
         <button class="btn" name="buttonValue" value="button1"><%= formattedCurrentDate%></button>
         <button class="btn" name="buttonValue" value="button2"><%= formattedNextDate%></button>
...
<select id="timeSlot" name="timeSlot" onchange="submitForm()">
  ...
  <option value="4:00 PM - 5:00 PM">4:00 PM - 5:00 PM</option>
    ...
    <form id="myForm1" action="electrician.jsp" method="post">
...
<br>
    ...
    <div id="userInfoContainer">
        ...
        if ("11:00 AM - 12:00 PM".equals(selectedTimeSlot)) {
            sqlQuery = "SELECT FIRST_NAME FROM SP WHERE TYPE = 'Electrician' AND CD_2 = true";
        } else if ("12:00 PM - 1:00 PM".equals(selectedTimeSlot)) {
            sqlQuery = "SELECT FIRST_NAME FROM SP WHERE TYPE = 'Electrician' AND CD_3 = true";
        } else if ("1:00 PM - 2:00 PM".equals(selectedTimeSlot)) {
            sqlQuery = "SELECT FIRST_NAME FROM SP WHERE TYPE = 'Electrician' AND CD_4 = true";
        }else if ("2:00 PM - 3:00 PM".equals(selectedTimeSlot)) {
            sqlQuery = "SELECT FIRST_NAME FROM SP WHERE TYPE = 'Electrician' AND CD_5 = true";
        }else if ("3:00 PM - 4:00 PM".equals(selectedTimeSlot)) {
            sqlQuery = "SELECT FIRST_NAME FROM SP WHERE TYPE = 'Electrician' AND CD_6 = true";
        }else if ("4:00 PM - 5:00 PM".equals(selectedTimeSlot)) {
            sqlQuery = "SELECT FIRST_NAME FROM SP WHERE TYPE = 'Electrician' AND CD_7 = true";
        } else {

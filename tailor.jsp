<%-- 
    Document   : tailor
    Created on : 8 Mar, 2024, 2:57:37 AM
    Author     : DELL
--%>
...
<select id="timeSlot" name="timeSlot" onchange="submitForm()">
  ...
  <option value="4:00 PM - 5:00 PM">4:00 PM - 5:00 PM</option>
    ...
    <form id="myForm1" action="tailor.jsp" method="post">
...
<br>
    ...
    <div id="userInfoContainer">
        ...
        if ("11:00 AM - 12:00 PM".equals(selectedTimeSlot)) {
            sqlQuery = "SELECT FIRST_NAME FROM SP WHERE TYPE = 'Tailor' AND CD_2 = true";
        } else if ("12:00 PM - 1:00 PM".equals(selectedTimeSlot)) {
            sqlQuery = "SELECT FIRST_NAME FROM SP WHERE TYPE = 'Tailor' AND CD_3 = true";
        } else if ("1:00 PM - 2:00 PM".equals(selectedTimeSlot)) {
            sqlQuery = "SELECT FIRST_NAME FROM SP WHERE TYPE = 'Tailor' AND CD_4 = true";
        }else if ("2:00 PM - 3:00 PM".equals(selectedTimeSlot)) {
            sqlQuery = "SELECT FIRST_NAME FROM SP WHERE TYPE = 'Tailor' AND CD_5 = true";
        }else if ("3:00 PM - 4:00 PM".equals(selectedTimeSlot)) {
            sqlQuery = "SELECT FIRST_NAME FROM SP WHERE TYPE = 'Tailor' AND CD_6 = true";
        }else if ("4:00 PM - 5:00 PM".equals(selectedTimeSlot)) {
            sqlQuery = "SELECT FIRST_NAME FROM SP WHERE TYPE = 'Tailor' AND CD_7 = true";
        } else {
